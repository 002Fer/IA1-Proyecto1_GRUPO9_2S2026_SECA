...
caso('caso-1','Asesinato en el Museo','Una valiosa pintura del siglo XVIII ha desaparecido del Museo Nacional de Arte durante la noche.',facil).
caso('caso-2','El Cientifico Desaparecido','El Dr. Sergio Montoya ha desaparecido dejando su laboratorio en caos.',medio).
caso('caso-3','El Gran Hotel','Un collar de diamantes valorado en 2 millones ha desaparecido durante una gala.',dificil).
